# FILE: gateway_server.py (Final Correct Version)
...
def search_ocr_on_elasticsearch(keyword: str, limit: int=100):
    ...
    try:
        ...
        # Nếu có lỗi:
        # 1. Ghi lại lỗi để gỡ lỗi sau này
        print(f"Đã xảy ra lỗi: {e}")
        # 2. DỪNG HÀM LẠI NGAY LẬP TỨC và trả về một giá trị mặc định an toàn
        return [] 
    ...
    for hit in response["hits"]["hits"]:
        ...
        # Ghép tên file: {video}_{shot_id}_{frame_id_6_số}.png
